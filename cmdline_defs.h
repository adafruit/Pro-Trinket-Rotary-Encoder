/*
 * This file is to provides the compiler any definitions that would usually go in the command line options, since Arduino IDE does not allow such additions
